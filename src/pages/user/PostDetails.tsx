...
import { getPostDetails, postComment } from '../../api/user';
    ...
    return (
        <div className="container mx-auto p-4 bg-gradient-to-r from-blue-300 via-green-200 to-teal-100">
            ...
            <div className="flex flex-col md:flex-row">
                ...
                <div className="bg-gray-200 flex space-x-1 p-2 shadow-lg rounded-lg w-2/3  mt-3">
                        {/* Supporting Documents Card */}
                        <div className="w-1/2 shadow-lg rounded-lg p-4 bg-white h-32">
                        ...
                        <div className="w-1/2 shadow-lg rounded-lg p-4 bg-white flex flex-col items-center h-32">
                            <h3 className="text-xl font-semibold mb-2 text-center">Fundraiser Details</h3>
                            <div className="flex  items-center">
                                <img
                                    className="w-14 h-14 rounded-full ml-3 shadow-md hover:shadow-lg transition-shadow duration-300"
            ...
            <Card className="bg-white shadow-lg rounded-lg w-[50%] mt-3 h-52">
                    <h3 className="text-xl font-semibold  text-center text-gray-800">Leave a Comment for support</h3>
                    <form onSubmit={handleCommentSubmit}>
                        ...
                        <button type='submit' className="bg-blue-500 text-white py-2 px-4 rounded-md mt-4 hover:bg-blue-600 transition duration-300 w-full">
                            Submit Comment
                        </button>
                    </form>
                </Card>
